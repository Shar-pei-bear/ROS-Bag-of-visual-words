...
int main(int argc, char *argv[]){
	...
	ifstream descfile;
	ofstream result("../result/outputsift.txt");
	ofstream tf_idresult("../result/tf_idmat.txt");
	ofstream hist_matresult("../result/hist_matsift.txt");
	vector<string> files = vector<string>();
	string line;
	
	pathfile.open("training_new.txt");
	infilecenter.open("./ClusterCenter/clustercenter600.txt");
	infilehistogram.open("./histogramfordifferentcluster/histogram600.txt");
	labelmatfile.open("./labelmat/labelmat600.txt");
	descfile.open("./labelmat/descriptor600.txt");
